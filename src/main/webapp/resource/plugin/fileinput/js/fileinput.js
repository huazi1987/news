...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        uploadLabel: '上传',
        uploadTitle: '上传已选取的文件',
        msgNo: 'No',
        msgNoFilesSelected: '没有选择的文件',
        msgCancelled: '已取消',
        msgPlaceholder: '选择 {files}...',
        msgZoomModalHeading: '检查预览',
        msgFileRequired: '你必须选择一个上传的文件',
        msgSizeTooSmall: '文件 "{name}" (<b>{size} KB</b>) 太小必须超过 <b>{minSize} KB</b>.',
        msgSizeTooLarge: '文件 "{name}" (<b>{size} KB</b>) 超过最大限制 <b>{maxSize} KB</b>.',
        msgFilesTooLess: '你必须选择最近的 <b>{n}</b> {files} 上传.',
        msgFilesTooMany: '上传文件数量 <b>({n})</b> 查过 <b>{m}</b> 的限制.',
        msgFileNotFound: '文件 "{name}" 未找到!',
        msgFileSecured: 'Security restrictions prevent reading the file "{name}".',
        msgFileNotReadable: '文件 "{name}" 不可读.',
        msgFilePreviewAborted: '文件 "{name}" 预览终止.',
        msgFilePreviewError: '读文件 "{name}" 错误.',
        msgInvalidFileName: '无效活着不支持的字符在文件 "{name}" 名中.',
        msgInvalidFileType: '验证 "{name}" 失效. 只有 "{types}" 类型的文件允许上传.',
        ...
        msgUploadAborted: '文件上传被终止',
        msgUploadThreshold: '上传中...',
        msgUploadBegin: '初始化中...',
        msgUploadEnd: '上传完成',
        msgUploadEmpty: '无已验证的数据上传',
        msgUploadError: '错误',
        msgValidationError: '验证错误',
        msgLoading: '加载文件{files} 中的第 {index} 个',
        msgProgress: '加载文件{files} 中的第 {index} 个 - {name} - {percent}% completed.',
